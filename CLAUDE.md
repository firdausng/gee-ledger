...
### Organizations, Plans & RBAC
- For details on organizations, subscriptions, plan tiers, pricing, feature gating, RBAC roles, and permissions, see `docs/internal/architecture-plans-rbac.md`
- For the feature roadmap and planned Pro plan expansions, see `docs/internal/pro-plan-features.md`
- Key config files: `src/lib/configurations/plans.ts` (plans) and `src/lib/configurations/policies.ts` (roles/permissions)
