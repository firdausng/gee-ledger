...
<div class="app-backdrop min-h-svh lg:py-4">
	<div class="app-shell mx-auto w-full max-w-7xl min-h-svh lg:min-h-[calc(100svh-2rem)] relative bg-background lg:rounded-xl overflow-hidden">
		<Sidebar.Provider>
...
<style>
	.app-backdrop {
		background:
			linear-gradient(135deg, oklch(0.93 0.02 230) 0%, oklch(0.91 0.03 240) 50%, oklch(0.93 0.02 220) 100%);
	}
	:global(:is(.dark)) .app-backdrop {
		background:
			linear-gradient(135deg, oklch(0.20 0.04 240) 0%, oklch(0.18 0.05 250) 50%, oklch(0.20 0.04 230) 100%);
	}

	.app-shell {
		box-shadow:
			0 0 0 1px var(--border),
			-12px 0 32px -8px oklch(0 0 0 / 0.06),
			12px 0 32px -8px oklch(0 0 0 / 0.06);
	}
	:global(:is(.dark)) .app-shell {
		box-shadow:
			0 0 0 1px var(--border),
			-12px 0 32px -8px oklch(0 0 0 / 0.4),
			12px 0 32px -8px oklch(0 0 0 / 0.4);
	}
</style>
